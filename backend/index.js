...
app.post('/deleteMultipleRows', authenticateToken, async (req, res) => {
  ...
  try {
    ...
    for (const row of rowsToDelete) {
      ...
      await deleteRowFromSpreadsheetMultiple(sheets, spreadSheetID, sheetName, rowIndex);
    }
...
async function deleteRowFromSpreadsheetMultiple(sheets, spreadSheetID, sheetName, rowIndex) {
  try {
    const requests = [
      {
        deleteDimension: {
