...
//   // Get values from the given range in the sheet
...
//         cellMeta = {
//           type: 'formula',
//           formula: cellValue, // Store the formula itself
//         };
//       } else {
//         cellMeta = {
...
//       // If the cell contains a formula that references another cell (generated)
//       if (cellValue.includes('=') && !cellValue.startsWith('=')) {
//         cellMeta.type = 'generated by formula';
//       }

//       // Store the metadata for the row and column
//       rowData[headerName] = cellMeta;
//     }

//     // Add row data under the appropriate row index
