function doGet(e) {
  ...
  if ((len.length == 0 && useremail == '') || page == null) {
    var htmlTemplate = HtmlService.createTemplateFromFile('Login')
  ...
  // master_sht.getRange('B11').getValue()
    ...
    var html = htmlTemplate.evaluate().setSandboxMode(HtmlService.SandboxMode.IFRAME).addMetaTag('viewport', 'width=device-width, initial-scale=1').setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
    return html;
  }
    ...
    if (c_code) {
      ...
      if (page == "customer_db") {
        ...
        if (role != 'boss') {
          ...
          var hidecol = master_sht.getRange("B31").getDisplayValue()
          var editcol = master_sht.getRange("B32").getDisplayValue()
        }
  ...
  // master_sht.getRange('B11').getValue(),
    ...
    var html = htmlTemplate.evaluate().setSandboxMode(HtmlService.SandboxMode.IFRAME).addMetaTag('viewport', 'width=device-width, initial-scale=1').setFaviconUrl(favicon).setTitle(page).setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
    return html;
    ...
    htmlTemplate.data = {
      ...
      'rw': e.parameter.rw,
      'vcod': vcod,
      'addContactUrl': 'https://script.google.com/a/macros/ceoitbox.in/s/AKfycbzvtaQ1dJ7jzxw5S2U5wVa5Ku98oAk-xWjiiNXpvYQp/dev',
