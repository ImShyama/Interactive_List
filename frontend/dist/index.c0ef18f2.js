...
})({"b9PeS":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "edd74128c0ef18f2";
"use strict";
...
},{"d1546958eb39fdcf":"d5jf4"}],"8Roby":[function(require,module,exports) {
...
function MultiselectDropdown(options) {
    ...
    function newEl(tag, attrs) {
        ...
        if (attrs !== undefined) Object.keys(attrs).forEach((k)=>{
            if (k === "class") Array.isArray(attrs[k]) ? attrs[k].forEach((o)=>o !== "" ? e.classList.add(o) : 0) : attrs[k] !== "" && e.classList.add(attrs[k]);
            else if (k === "style") Object.keys(attrs[k]).forEach((ks)=>{
    ...
    document.querySelectorAll("select[multiple]").forEach((el, k)=>{
        ...
        el.loadOptions = ()=>{
            ...
            div.refresh = ()=>{
                ...
                if (sels.length > (el.attributes["multiselect-max-items"]?.value ?? 5)) div.appendChild(newEl("span", {
                    class: [
                        "optext",
                        "maxselected"
                    ],
                    ...
                    if (el.attributes["multiselect-hide-x"]?.value !== "true") c.appendChild(newEl("span", {
                        class: "optdel",
                        text: "\uD83D\uDDD9",
...
},{}]},["b9PeS","1xC6H","8Roby"], "8Roby", "parcelRequire9b73")

//# sourceMappingURL=index.c0ef18f2.js.map
