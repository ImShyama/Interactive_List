...
const ContentSection = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col  bg-white px-10">
      ...
      <div className="text-[84.052px] font-poppins justify-center text-center font-bold leading-normal bg-gradient-to-r from-[#598931] to-[#97CE69] bg-clip-text text-transparent">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-center w-full relative">
        ...
        <motion.img
          src={GoogleSlide5}
          alt="Google Slide 5"
          className="w-[40vw] h-[25vw]" // Adjusted for viewport responsiveness
        ...
        <img
          src={ArrowUpper}
          alt="Arrow Upper"
          className="absolute top-[50%] left-[41%] w-[450px] rotate-[1deg]"
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        />

        <ul className="list-disc pl-6 space-y-4 md:pl-10 md:mt-10 text-[#323232] font-poppins text-[50.211px] font-normal leading-normal w-[800px]">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between w-full">
        ...
        <div className="text-left text-sm md:text-base mt-6 md:mt-0 md:w-1/2">
          <ul className="list-disc pl-6 space-y-4 md:pl-10 md:mt-10 text-[#323232] font-poppins text-[50.211px] font-normal leading-normal w-[780px]">
        ...
        <div className="relative w-full flex justify-center mt-2">
          ...
          <motion.img
            ...
            className="absolute"
            style={{
              top: "-6vh", // Adjust positioning based on viewport height
              left: "2vw", // Position it dynamically from the left
              width: "25vw", // Adjust width to scale proportionally
            }}
            initial={{ scale: 0.6 }}
          ...
          <motion.img
            ...
            style={{
              ...
              left: "10vw", // Position it dynamically from the left
              width: "25vw", // Adjust width to scale proportionally
            }}
            initial={{ scale: 1 }}
          ...
          <motion.img
            ...
            style={{
              top: "-6vh", // Adjust positioning based on viewport height
              left: "23vw", // Position it dynamically from the left
              width: "25vw", // Adjust width to scale proportionally
            }}
            initial={{ scale: 0.6 }}
            animate={{ scale: [0.6, 1, 0.6] }}
          ...
          <img
            src={ArrowBelow}
            alt="Arrow Below"
            className="absolute top-[220px] right-[79%] w-[25vw] rotate-[2deg]"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center mt-10 relative">
        <div className="absolute top-1/2 left-[210px] z-10">
          <motion.img
            src={Star}
            alt="Logo"
            className="w-[280px]"
        ...
        <div className="absolute top-1/2 left-[300px] transform scale-150">
          <img src={SmallCircle} alt="Small Circle" />
        </div>
      </div>
      {/* CTA Buttons */}
      <div className="mb-10 ml-[50%] flex flex-col items-start">
        <p className="mt-4 text-[#353535] font-poppins text-[45.514px]">
          Try Our App For the Same!!
        </p>
        <div className="flex gap-6">
          <button
            className="bg-[#598931] text-white px-10 py-3 text-lg font-semibold rounded-xl shadow-lg"
