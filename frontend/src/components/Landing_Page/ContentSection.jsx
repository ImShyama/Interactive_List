...
//               left: "4vw", // Position it dynamically from the left
...
//             style={{
//               top: "2vh", // Adjust positioning based on viewport height
//               left: "16vw", // Position it dynamically from the left
//               width: "26vw", // Adjust width to scale proportionally
//             }}
//             initial={{ scale: 1 }}
...
//             style={{
//               top: "-2vh", // Adjust positioning based on viewport height
//               left: "28vw", // Position it dynamically from the left
//               width: "26vw", // Adjust width to scale proportionally
//             }}
//             initial={{ scale: 0.6 }}
//             animate={{ scale: [0.6, 1, 0.6] }}
...
const ContentSection = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col  bg-white px-10 ">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-center w-full relative mb-10">
        
        <motion.img
          src={GoogleSlide5}
          alt="Google Slide 5"
          className="w-[38vw] h-[22vw] ml-[-5%]" // Adjusted for viewport responsiveness
          style={{ marginRight: "10%", marginTop: "-1%" }}
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        ...
        <img
          src={ArrowUpper}
          alt="Arrow Upper"
          className="absolute top-[60%] left-[42%] w-[350px] rotate-[1deg]"
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        />

        <ul className="list-disc pl-4 space-y-4 md:pl-5 md:mt-20 text-[#323232] font-poppins text-[28px] font-normal leading-normal w-[650px] ml-[-120px]">
          <li>Tired of Unorganized and Complex Data?</li>
          <li>Can’t Find What is Actually Needed?</li>
        </ul>
      </div>

      <div className="flex flex-col md:flex-row md:items-start md:justify-between w-full mb-20">
        {/* Text Section */}
        <div className="text-left text-sm md:text-base mt-6 md:mt-0 md:w-1/2">
          <ul className="list-disc pl-16 space-y-4 md:pl-[93px] md:mt-10 text-[#323232] font-poppins text-[28px] font-normal leading-normal w-[650px] ml-[25px]">
            <li>Want such type of Organized and Clean Data?</li>
            <li>Which will be easy to Access, Share, and Easy to Find.</li>
          </ul>
        </div>
        ...
        <div className="relative w-full flex justify-center mt-2 ">
          ...
          <img
            src={ArrowBelow}
            alt="Arrow Below"
            className="absolute top-[210px] right-[75%] w-[18vw] rotate-[10deg]"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center relative">
        <div className="absolute top-1/2 left-[385px] z-10">
          <motion.img
            src={Star}
            alt="Logo"
            className="w-[180px]"
        ...
        <div className="absolute top-1/2 left-[420px] transform scale-120">
          <img src={SmallCircle} alt="Small Circle" />
        </div>
      </div>
      {/* CTA Buttons */}
      <div className="mb-20 ml-[48%] flex flex-col items-start">
        <p className="mt-4 text-[#353535] font-poppins text-[32px]">
          Try Our App For the Same!!
        </p>
        <div className="flex gap-6">
          <button
