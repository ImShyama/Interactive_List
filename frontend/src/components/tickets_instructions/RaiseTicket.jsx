...
//     if (file) {
//       finalData["Upload Problem Screenshot"] = file;
//     }

//     setLoading(true);
//     try {
//       const { data: res } = await axios.post(`${url}/helpdesk/raiseTicket`, finalData);
...
//             </div>
//             <div>
//               <h2 className="text-lg font-semibold text-[#334155] m-0">Raise Support Ticket</h2>
