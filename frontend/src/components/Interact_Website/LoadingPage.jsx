...
//   return (
//     <div className="h-screen w-full flex flex-col items-center justify-center text-center px-4 relative">
//       {/* Logo and Title */}
//       <motion.div
...
//       >
//         <FaMouse className="text-2xl text-gray-700" />
//         <div className="animate-bounce text-gray-700 mt-1">▼</div>
//       </motion.div>
//     </div>
//   );
// };
...
// const LoadingPage = ({ onScroll }) => {
//   return (
//     <div className="min-h-screen w-full flex flex-col items-center justify-center text-center px-4 relative overflow-y-auto">
//       {/* Content Wrapper */}
//       <motion.div
//         initial={{ opacity: 0, y: 10 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.8 }}
//         className="bg-white/70 backdrop-blur-lg px-6 py-12 rounded-3xl shadow-md max-w-3xl w-full"
//       >
//         {/* Logo and Title */}
//         <div className="flex items-center justify-center mb-6">
//           <img
//             src="/your-logo-path.svg" // replace with actual logo
//             alt="Interactive Logo"
//             className="w-6 h-6 mr-2"
//           />
//           <span className="text-lg font-semibold">INTERACTIVE</span>
...
//       <motion.div
//         onClick={onScroll}
//         className="absolute bottom-6 cursor-pointer flex flex-col items-center"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
//         transition={{ delay: 1.5, duration: 1 }}
//       >
//         <FaMouse className="text-2xl text-gray-700" />
//         <div className="animate-bounce text-gray-700 mt-1 text-lg">▼</div>
//       </motion.div>
//     </div>
//   );
// };
...
//   return (
//     <div className="min-h-screen w-full flex flex-col items-center justify-center text-center px-4 relative overflow-y-auto">
//       {/* Content Wrapper with custom border-radius and background */}
//       <motion.div
//         initial={{ opacity: 0, y: 10 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.8 }}
...
//           background: "#F4FDED",
//         }}
//         className="backdrop-blur-lg px-6 py-20 shadow-md max-w-3xl w-full"
//       >
//         {/* Logo and Title */}
//         <div className="flex items-center justify-center mb-6">
//           <img
...
// const LoadingPage = ({ onScroll }) => {
//   return (
//     <div className="min-h-screen w-full flex items-center justify-center text-center px-4 relative overflow-y-auto">
//       {/* Content Wrapper */}
//       <motion.div
//         initial={{ opacity: 0, y: 10 }}
//         animate={{ opacity: 1, y: 0 }}
...
//         {/* Scroll Icon to the right of the card */}
//         <motion.div
//           onClick={onScroll}
//           className="absolute right-[-10px] top-1/2 transform -translate-y-1/2 cursor-pointer flex flex-col items-center"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           transition={{ delay: 1.5, duration: 1 }}
//         >
